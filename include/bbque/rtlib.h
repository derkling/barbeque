 ...
 */
RTLIB_ExitCode RTLIB_Init(const char* name, RTLIB_Services_t **services);
 ...
 */
typedef struct RTLIB_ExecutionContextParams* RTLIB_ExecutionContextHandler_t;
 ...
 */
typedef RTLIB_ExitCode (*RTLIB_Stop_t)(
