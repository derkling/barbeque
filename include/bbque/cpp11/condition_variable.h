...
#ifndef BBQUE_CONDITION_VARIABLE_H_
#define BBQUE_CONDITION_VARIABLE_H_
...
#include "bbque/cpp11/gnu/condition_variable.h"
#endif // CONFIG_TARGET_SUPPORT_CPP11

#endif /* end of include guard: BBQUE_CONDITION_VARIABLE_H_ */
